...
#define QF_EQUEUE_TYPE        k_queue
#define QF_THREAD_TYPE        k_thread

/* The maximum number of active objects in the application, see NOTE1 */
#define QF_MAX_ACTIVE         32

/* QF interrupt disabling/enabling (task level) */
#define QF_INT_DISABLE()      irq_lock()
#define QF_INT_ENABLE()       irq_unlock(key) /* FIXME: unlock the interrupt need a key in zephyr */
