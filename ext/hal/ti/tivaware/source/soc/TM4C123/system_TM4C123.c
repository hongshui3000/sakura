...
#define RCC_Val \
    (           \
        ((CFG_RCC_SYSDIV - 1) << 23) | (CFG_RCC_USESYSDIV << 22) | (CFG_RCC_USEPWMDIV << 20) | (CFG_RCC_PWMDIV << 17) | (CFG_RCC_PWRDN << 13) | (CFG_RCC_BYPASS << 11) | (CFG_RCC_XTAL << 6) | (CFG_RCC_OSCSRC << 4) | (CFG_RCC_IOSCDIS << 1) | (CFG_RCC_MOSCDIS << 1))
...
#define __CORE_CLK CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC
...
/* FPU settings ------------------------------------------------------------*/
    ...
    if ((((RCC_Val & (1UL << 13)) == 0) && ((RCC2_Val & (1UL << 31)) == 0)) || (((RCC2_Val & (1UL << 13)) == 0) && ((RCC2_Val & (1UL << 31)) != 0))) {
