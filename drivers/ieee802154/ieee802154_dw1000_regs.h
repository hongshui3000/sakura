...
/* offset from EXT_SYNC_ID in bytes */
#define DW1000_GPIO_IBES_OFFSET 0x1C /* sub-register 0x1C is the GPIO interrupt �Both Edge� selection register */
#define DW1000_GPIO_IBES_LEN (4)
#define DW1000_GPIO_IBES_MASK GPIO_IRQE_MASK /*  */
#define DW1000_GIBES0 GIRQx0 /* GPIO IRQ �Both Edge� selection for GPIO0 input. Value 0 = GPIO_IMODE register selects the edge. Value 1 = Both edges trigger the interrupt. */
...
#define DW1000_DRX_TUNE0b_MASK 0xFFFF /* 7.2.40.2 Sub-Register 0x27:02 � DRX_TUNE0b */
...
/* offset from DRX_CONF_ID in bytes */
#define DW1000_DRX_TUNE1a_OFFSET 0x04 /* 7.2.40.3 Sub-Register 0x27:04 � DRX_TUNE1a */
...
/* offset from DRX_CONF_ID in bytes */
#define DW1000_DRX_TUNE1b_OFFSET 0x06 /* 7.2.40.4 Sub-Register 0x27:06 � DRX_TUNE1b */
...
/* offset from DRX_CONF_ID in bytes */
#define DW1000_DRX_TUNE2_OFFSET 0x08 /* 7.2.40.5 Sub-Register 0x27:08 � DRX_TUNE2 */
 ...
 */
#define DW1000_DRX_SFDTOC_OFFSET 0x20 /* 7.2.40.7 Sub-Register 0x27:20 � DRX_SFDTOC */
#define DW1000_DRX_SFDTOC_LEN (2)
#define DW1000_DRX_SFDTOC_MASK 0xFFFF

/* offset from DRX_CONF_ID in bytes */
#define DW1000_DRX_PRETOC_OFFSET 0x24 /* 7.2.40.9 Sub-Register 0x27:24 � DRX_PRETOC */
#define DW1000_DRX_PRETOC_LEN (2)
#define DW1000_DRX_PRETOC_MASK 0xFFFF

/* offset from DRX_CONF_ID in bytes */
#define DW1000_DRX_TUNE4H_OFFSET 0x26 /* 7.2.40.10 Sub-Register 0x27:26 � DRX_TUNE4H */
...
#define DW1000_RF_TXCTRL_CH1 0x00005C40UL /* 32-bit value to program to Sub-Register 0x28:0C � RF_TXCTRL */
#define DW1000_RF_TXCTRL_CH2 0x00045CA0UL /* 32-bit value to program to Sub-Register 0x28:0C � RF_TXCTRL */
#define DW1000_RF_TXCTRL_CH3 0x00086CC0UL /* 32-bit value to program to Sub-Register 0x28:0C � RF_TXCTRL */
#define DW1000_RF_TXCTRL_CH4 0x00045C80UL /* 32-bit value to program to Sub-Register 0x28:0C � RF_TXCTRL */
#define DW1000_RF_TXCTRL_CH5 0x001E3FE0UL /* 32-bit value to program to Sub-Register 0x28:0C � RF_TXCTRL */
#define DW1000_RF_TXCTRL_CH7 0x001E7DE0UL /* 32-bit value to program to Sub-Register 0x28:0C � RF_TXCTRL */
...
/* offset from TX_CAL_ID in bytes */
#define DW1000_TC_PGDELAY_OFFSET 0x0B /* Transmitter Calibration � Pulse Generator Delay */
...
/* offset from TX_CAL_ID in bytes */
#define DW1000_TC_PGTEST_OFFSET 0x0C /* Transmitter Calibration � Pulse Generator Test */
...
/* offset from FS_CTRL_ID in bytes */
#define DW1000_FS_PLLCFG_OFFSET 0x07 /* Frequency synthesiser � PLL configuration */
...
/* offset from FS_CTRL_ID in bytes */
#define DW1000_FS_PLLTUNE_OFFSET 0x0B /* Frequency synthesiser � PLL Tuning */
...
/* offset from FS_CTRL_ID in bytes */
#define DW1000_FS_XTALT_OFFSET 0x0E /* Frequency synthesiser � Crystal trim */
#define DW1000_FS_XTALT_LEN (1)
#define DW1000_FS_XTALT_MASK 0x1F /* Crystal Trim. Crystals may be trimmed using this register setting to tune out errors, see 8.1 � IC Calibration � Crystal Oscillator Trim. */
...
#define DW1000_AON_CFG1_LPOSC_CAL 0x0004 /* This bit enables the calibration function that measures the period of the IC�s internal low powered oscillator */
...
/* offset from DIG_DIAG_ID in bytes */
#define DW1000_EVC_HPW_OFFSET 0x18 /* The EVC_HPW field is a 12-bit counter of �Half Period Warnings�. */
#define DW1000_EVC_HPW_LEN (2)
#define DW1000_EVC_HPW_MASK 0x0FFF
/* offset from DIG_DIAG_ID in bytes */
#define DW1000_EVC_TPW_OFFSET 0x1A /* The EVC_TPW field is a 12-bit counter of �Transmitter Power-Up Warnings�. */
